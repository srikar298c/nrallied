...
//   }
  ...
  const handleModalSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault()
    // Here you can send visitor info to your backend/analytics
            ...
            <form onSubmit={handleModalSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0476D9] focus:border-transparent outline-none transition-colors"
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  type="submit"
                  className="flex-1 px-4 py-2 bg-[#0476D9] text-white rounded-lg hover:bg-[#0476D9]/80 transition-colors flex items-center justify-center gap-2"
                >
