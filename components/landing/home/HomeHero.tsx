  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url(https://images.pexels.com/photos/175773/pexels-photo-175773.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)',
        }}
      >
        <div
        ...
        <div className="grid md:grid-cols-[1.3fr_1fr] gap-12 items-center">
          ...
          <div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              ...
              <span
                className="bg-gradient-to-r from-[#F14472] via-[#AB64F2] to-[#F24C26] bg-clip-text text-transparent"
                // style={{ fontFamily: 'TakenByVultures' }}
              >
                but partnerships.
              </span>
            </h1>
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-8">
              NR Allied provides premium plastic packaging solutions across
              multiple industries with a production capacity of 17 lakh bottles
              per day.
            </p>

            <div className="flex flex-col sm:flex-row gap-4">
              <Button className="py-2 px-4">Get in Touch</Button>
            ...
            <div className="mt-16 flex items-center">
              <div className="flex -space-x-4">
                ...
                <Image
                  ...
                  height={100}
                  alt="Client"
                  className="w-12 h-12 rounded-full border-2 border-white bg-red-500"
                />
                <Image
          ...
          <div className="hidden md:flex justify-center">
            <Image
              src="/images/hero-product.png" // Replace with your actual image
              alt="Hero Product"
              width={600}
              height={600}
              className="rounded-xl shadow-lg object-contain max-h-[520px]"
            />
          </div>
        </div>
      </div>
