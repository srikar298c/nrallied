  ...
  return (
    <div className={`mb-12 ${centered ? 'text-center' : ''} ${className}`}>
     <div className="relative inline-flex flex-wrap items-center justify-center gap-x-6 overflow-visible">
        ...
        {/* Title */}
        <span className="relative z-0 font-[Fontspring] text-gray-900 text-3xl md:text-4xl lg:text-5xl font-bold">
          {title}
        </span>
        ...
        {highlight && (
         <span
         className="relative z-10 bg-gradient-to-r from-[#F14472] via-[#AB64F2] to-[#F24C26] bg-clip-text text-transparent text-5xl md:text-7xl lg:text-8xl xl:text-9xl"
         style={{
